...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    props.addNew({
      content: content.inputValues.value,
      author: author.inputValues.value,
      info: info.inputValues.value,
      votes: 0
    })
    props.setNotification(`new anecdote ${content.inputValues.value} created!`)
    navigate('/')
  }
